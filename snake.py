...
font_style = pygame.font.SysFont("arial",26)
...
def game_loop():
    ...
    while not gameOver:
        ...
        while gameClose == True:
            ...
            snake_lenght_list.append(snake_size)
            if len(snake_lenght_list)>snake_length:
                del snake_lenght_list[0]

                game_snake(snake,snake_lenght_list)
                user_score(snake_length - 1)
